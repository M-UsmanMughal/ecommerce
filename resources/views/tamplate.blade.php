	...
	<header class="header-v4">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="{{route('feature')}}">Shoping Cart</a>
							</li>
							<li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{route('feature')}}" class="label1 rs1" data-label1="hot">Shoping Cart</a>
				</li>
				<li>
					<a href="{{route('about')}}">About</a>
				</li>
				...
				<li>
					<a href="c{{route('contact')}}">Contact</a>
				</li>
			</ul>
		</div>
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('website/images/item-cart-01.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('website/images/item-cart-02.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('website/images/item-cart-03.jpg')}}" alt="IMG">
						</div>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="{{route('feature')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>

						<a href="{{route('feature')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
